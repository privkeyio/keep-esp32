...
static const uint8_t AES_GCM_TEST_NONCE[12] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00
};
static const uint8_t AES_GCM_TEST_PT[16] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
static const uint8_t AES_GCM_TEST_CT[16] = {
    0x0e, 0xbc, 0xb5, 0xde, 0xb5, 0x2c, 0x83, 0xbd,
    0x08, 0xa8, 0xa9, 0x35, 0x18, 0x2c, 0x91, 0x99
};
static const uint8_t AES_GCM_TEST_TAG[16] = {
...
int self_test_storage_crypto(void) {
    ...
    if (mbedtls_gcm_crypt_and_tag(&gcm, MBEDTLS_GCM_ENCRYPT, sizeof(AES_GCM_TEST_PT),
                                   AES_GCM_TEST_NONCE, sizeof(AES_GCM_TEST_NONCE),
                                   NULL, 0, AES_GCM_TEST_PT, output, sizeof(tag), tag) != 0) {
        goto cleanup;
    }
    ...
    if (mbedtls_gcm_auth_decrypt(&gcm, sizeof(AES_GCM_TEST_CT), AES_GCM_TEST_NONCE,
                                  sizeof(AES_GCM_TEST_NONCE), NULL, 0,
                                  AES_GCM_TEST_TAG, sizeof(AES_GCM_TEST_TAG),
                                  AES_GCM_TEST_CT, output) != 0) {
        goto cleanup;
    }

...
static inline int mbedtls_gcm_crypt_and_tag(mbedtls_gcm_context *ctx, int mode, size_t length,
    ...
    (void)add;
    (void)add_len;
    static const uint8_t expected_key[32] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
                                             0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
                                             0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
                                             0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f};
    static const uint8_t expected_ct[16] = {0x0e, 0xbc, 0xb5, 0xde, 0xb5, 0x2c, 0x83, 0xbd,
                                            0x08, 0xa8, 0xa9, 0x35, 0x18, 0x2c, 0x91, 0x99};
    static const uint8_t expected_tag_v[16] = {0x38, 0x62, 0x64, 0x29, 0x86, 0xc9, 0x53, 0xe8,
...
static inline int mbedtls_gcm_auth_decrypt(mbedtls_gcm_context *ctx, size_t length,
                                           const uint8_t *iv, size_t iv_len, const uint8_t *add,
                                           size_t add_len, const uint8_t *tag, size_t tag_len,
